...
CREATE SEQUENCE  "DB7"."DS_QA_SEQ"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL;
/*</추가 10/26> ------------------------------------------------------------------------------------*/
...
CREATE SEQUENCE  "DB7"."DS_TQA_SEQ"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL;
...
UPDATE ds_qa SET qa_date=sysdate, qa_replydate=sysdate;
UPDATE ds_tqa SET tqa_replydate=sysdate;
commit;