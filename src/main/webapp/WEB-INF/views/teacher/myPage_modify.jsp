			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="body">						
							...
							<form role="form" action="/teacher/myPage_modify" method="post">
...
$(document).ready(function(){
    ...
    $('#btnCancel').on("click",function(){
		location.href="/teacher/myPage?user_id=<sec:authentication property='principal.user.user_id'/>";
    });

    $('#btnModal').on("click", function(){
    	formObj.attr("action", "/teacher/user_delete").submit();        
    });
});
</script>
