 ...
 <div class="container-fluid">
                    ...
                    <div class="card">
                      <form method="get" action="">
                        <div class="header">
                            <h2>
                                	등록된 학생 목록
                                	<input type="button" id="regBtn" class="btn bg-red waves-effect" value="수강해제" style="float:right;">
                                <small>잘못 등록한 학생이있으면 체크박스에 체크한뒤 버튼을 눌러주세요. </small>
                            </h2>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <form method="get" action="">
                        <div class="header">
                            <h2>
                                	수강신청한 학생 목록
                                	<input type="button" id="regBtn" class="btn bg-red waves-effect" value="수강등록" style="float:right;">
                                <small>등록하고자 하는 학생이있으면 체크박스에 체크한뒤 버튼을 눌러주세요.</small>
                            </h2>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card" >
  						<button type="button" id = "start_class" class="btn btn-primary waves-effect" style="float:right;">수업시작</button>
                    </div>
                </div>
            </div>
